...
This version of the plugin assumes that you will be taking care of the actual payment process yourself. If you'd rather like the plugin to cover this for you, we are offering a different version of the plugin with native support for Braintree Payment Services, where you will be able to offer payment via both, _PayPal_ and credit cards. 
