package com.scheidtbachmann.demoapp.thirdpartypsp;
...
public class MainActivity extends AppCompatActivity implements SBCheckOutDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                plugin.setOutroAnimation(android.R.anim.slide_out_right);
    ...
    public void onStatus(SBCheckOutStatus newStatus, final SBCheckOutTransaction info) {
        ...
        if ( newStatus == SBCheckOutStatus.FLOW_FINISHED) {
            if ( info != null && info.getSuccess()) {
                ...
                Log.i( "DEMOAPP", "no transaction info available");
            }
        }
    ...
    public void onConductPayment( String sessionToken) {
        ...
        /*
         * this is where normally all the 3rd party payment stuff will be taking place
         * for testing purposes, we just complete the transaction
         */
